-- =============================================
-- KSU CONNECT - Supabase Database Schema
...
-- =============================================
-- SUSPENDED ACCOUNTS BLOCK LIST
-- =============================================
-- The profiles.is_suspended column + RLS handles suspension.
-- We add a function to enforce suspension on writes.
